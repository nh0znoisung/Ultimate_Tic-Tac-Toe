...
lose = 0
cnt = 1000
f = open("Statitis7.txt", "a")

print("******model_52_284model_52_284 go first")
for i in range(cnt):
    print("Phrase {}:".format(i))
    main('NN_MCTS3', 'random_agent', 2)

print("          | Win | Lose | Draw")
print("Player 1  | {} | {} | {}".format(win, cnt - win - draw, draw))
print("Player 2  | {} | {} | {}".format(cnt - win - draw, win, draw))
f.write("model_52_284 vs Random, model_52_284 go first, play 1k games: Win rate: {}".format(win/cnt))

win = 0
draw = 0
lose = 0
print("******model_52_284 go second")
for i in range(cnt):
    print("Phrase {}:".format(i))
    main('random_agent', 'NN_MCTS3', 2)

print("          | Win | Lose | Draw")
print("Player 1  | {} | {} | {}".format(win, cnt - win - draw, draw))
print("Player 2  | {} | {} | {}".format(cnt - win - draw, win, draw))
f.write("model_52_284 vs Random, model_52_284 go second, play 1k games: Win rate: {}".format(
    (cnt - win - draw)/cnt))
